              ...
              <tbody className="divide-y divide-white/5">
                {filteredUsers.map((user: any, i: number) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <Badge variant="outline" className={user.isVerified ? "bg-green-500/20 text-green-400 border-green-500/30" : "bg-yellow-500/20 text-yellow-400 border-yellow-500/30"}>
